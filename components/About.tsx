...
function About({pageInfo}: Props) {
  return (
    <main className='flex flex-col h-screen relative text-center md:text-left md:flex-row md:px-10 max-w-7xl justify-between mx-auto items-center'>
        ...
        <section className='space-y-9 px-0 md:px-10'>
            <h4 className='text-4xl font-semibold capitalize'>here is a <span className='underline decoration-dark-bittersweet'>little</span> background</h4>
