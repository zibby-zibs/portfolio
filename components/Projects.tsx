...
function Projects({projects}: Props) {
  ...
  return (
    <main className='h-screen relative flex overflow-hidden flex-col text-left md:flex-row max-w-full justify-between mx-auto items-center z-0'>
        ...
        <section className='relative mt-16 sm:mt-11 w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20'>
           {projects?.map((project, i)=>{
            return (
                <div key={project?._id} className='w-screen xl:mt-24 flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen'>
                    <div className='h- w-full mb-3 mt-3 sm:px-24 '>
                        <Image 
        ...
        <section className='w-full absolute top-[30%] bg-dark-bittersweet/30 left-0 h-[400px] -skew-y-12'>
