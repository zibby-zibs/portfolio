  ...
  return (
    <main className='h-screen flex relative flex-col text-center md:flex-row max-w-7xl px-10 justify-between mx-auto items-center space-y-20'>
        <div className='absolute top-20 w-full h-20 flex justify-center'>
            <h3 className='uppercase text-dark-bittersweet/30 text-4xl font-bold tracking-[10px] md:text-6xl md:tracking-[15px]'>
                contact
            </h3>
        ...
        <div className='flex flex-col mt-30 min-w-full'>
            ...
            <div className='flex flex-col justify-between m-3 mx-auto md:flex-row gap-4'>
                <div className='flex items-center justify-center'>
                    ...
                    <p className='text-lg md:text-2xl xl:text-2xl'>{pageInfo?.phoneNumber}</p>
                </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-2 mx-auto'>
                ...
                <button type='submit' className='bg-dark-bittersweet py-5 px-18 rounded-md text-ming-100 uppercase font-semibold text-lg'>submit</button>
            </form>
