			...
			<section className="w-full flex snap-x snap-mandatory h-4/5 overflow-x-scroll space-x-5 mt-24 items-center xl:mt-44 scrollbar-none overflow-auto">
				{experience.map((experience) => {
					return (
						<article
							key={experience?._id}
							className="px-5 text-ming-50 w-[80%] h-3/4  flex-shrink-0 rounded-lg snap-center bg-dark-bittersweet/40 hover:bg-dark-bittersweet/60 cursor-pointer transition-opacity duration-200 overflow-auto scrollbar-none drop-shadow-lg"
						>
							{/* <motion.div
                      initial={{
                          y: -100,
